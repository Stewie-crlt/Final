  ...
  template<typename Stream> static void stream(Stream& s, const std::string& indent, const ::rm_msgs::ActuatorState_<ContainerAllocator>& v)
  {
    ...
    for (size_t i = 0; i < v.stamp.size(); ++i)
    {
      if (true && i > 0)
        ...
        s << std::endl << indent << "  -";
      Printer<ros::Time>::stream(s, true ? std::string() : indent + "    ", v.stamp[i]);
    }
    if (v.stamp.empty() || true)
      s << "]";
    ...
    for (size_t i = 0; i < v.bus.size(); ++i)
    {
      if (true && i > 0)
        ...
        s << std::endl << indent << "  -";
      Printer<std::basic_string<char, std::char_traits<char>, typename std::allocator_traits<ContainerAllocator>::template rebind_alloc<char>>>::stream(s, true ? std::string() : indent + "    ", v.bus[i]);
    }
    if (v.bus.empty() || true)
      s << "]";
    if (true || !indent.empty())
    ...
    for (size_t i = 0; i < v.halted.size(); ++i)
    {
      if (true && i > 0)
        ...
        s << std::endl << indent << "  -";
      Printer<uint8_t>::stream(s, true ? std::string() : indent + "    ", v.halted[i]);
    }
    if (v.halted.empty() || true)
      s << "]";
    if (true || !indent.empty())
      s << std::endl;
    s << indent << "need_calibration: ";
    if (v.need_calibration.empty() || true)
      s << "[";
    for (size_t i = 0; i < v.need_calibration.size(); ++i)
    {
      if (true && i > 0)
        ...
        s << std::endl << indent << "  -";
      Printer<uint8_t>::stream(s, true ? std::string() : indent + "    ", v.need_calibration[i]);
    }
    if (v.need_calibration.empty() || true)
      s << "]";
    if (true || !indent.empty())
    ...
    for (size_t i = 0; i < v.calibrated.size(); ++i)
    {
      if (true && i > 0)
        ...
        s << std::endl << indent << "  -";
      Printer<uint8_t>::stream(s, true ? std::string() : indent + "    ", v.calibrated[i]);
    }
    if (v.calibrated.empty() || true)
      s << "]";
    if (true || !indent.empty())
    ...
    if (v.calibration_reading.empty() || true)
      s << "[";
    for (size_t i = 0; i < v.calibration_reading.size(); ++i)
    {
      if (true && i > 0)
        ...
        s << std::endl << indent << "  -";
      Printer<uint8_t>::stream(s, true ? std::string() : indent + "    ", v.calibration_reading[i]);
    }
    if (v.calibration_reading.empty() || true)
      s << "]";
    if (true || !indent.empty())
      s << std::endl;
    s << indent << "position_raw: ";
    if (v.position_raw.empty() || true)
      s << "[";
    for (size_t i = 0; i < v.position_raw.size(); ++i)
    {
      if (true && i > 0)
        ...
        s << std::endl << indent << "  -";
      Printer<uint16_t>::stream(s, true ? std::string() : indent + "    ", v.position_raw[i]);
    }
    if (v.position_raw.empty() || true)
      s << "]";
    if (true || !indent.empty())
      s << std::endl;
    s << indent << "velocity_raw: ";
    if (v.velocity_raw.empty() || true)
      s << "[";
    for (size_t i = 0; i < v.velocity_raw.size(); ++i)
    {
      if (true && i > 0)
        ...
        s << std::endl << indent << "  -";
      Printer<int16_t>::stream(s, true ? std::string() : indent + "    ", v.velocity_raw[i]);
    }
    if (v.velocity_raw.empty() || true)
      s << "]";
    if (true || !indent.empty())
    ...
    for (size_t i = 0; i < v.temperature.size(); ++i)
    {
      if (true && i > 0)
        ...
        s << std::endl << indent << "  -";
      Printer<uint8_t>::stream(s, true ? std::string() : indent + "    ", v.temperature[i]);
    }
    if (v.temperature.empty() || true)
      s << "]";
    if (true || !indent.empty())
    ...
    for (size_t i = 0; i < v.circle.size(); ++i)
    {
      if (true && i > 0)
        ...
        s << std::endl << indent << "  -";
      Printer<int64_t>::stream(s, true ? std::string() : indent + "    ", v.circle[i]);
    }
    if (v.circle.empty() || true)
      s << "]";
    if (true || !indent.empty())
      s << std::endl;
    s << indent << "last_position_raw: ";
    if (v.last_position_raw.empty() || true)
      s << "[";
    for (size_t i = 0; i < v.last_position_raw.size(); ++i)
    {
      if (true && i > 0)
        ...
        s << std::endl << indent << "  -";
      Printer<uint16_t>::stream(s, true ? std::string() : indent + "    ", v.last_position_raw[i]);
    }
    if (v.last_position_raw.empty() || true)
      s << "]";
    if (true || !indent.empty())
    ...
    for (size_t i = 0; i < v.frequency.size(); ++i)
    {
      if (true && i > 0)
        ...
        s << std::endl << indent << "  -";
      Printer<double>::stream(s, true ? std::string() : indent + "    ", v.frequency[i]);
    }
    if (v.frequency.empty() || true)
      s << "]";
    if (true || !indent.empty())
    ...
    if (true || !indent.empty())
      s << std::endl;
    s << indent << "executed_effort: ";
    if (v.executed_effort.empty() || true)
      s << "[";
    for (size_t i = 0; i < v.executed_effort.size(); ++i)
    {
      if (true && i > 0)
        ...
        s << std::endl << indent << "  -";
      Printer<double>::stream(s, true ? std::string() : indent + "    ", v.executed_effort[i]);
    }
    if (v.executed_effort.empty() || true)
      s << "]";
    if (true || !indent.empty())
    ...
    for (size_t i = 0; i < v.offset.size(); ++i)
    {
      if (true && i > 0)
        ...
        s << std::endl << indent << "  -";
      Printer<double>::stream(s, true ? std::string() : indent + "    ", v.offset[i]);
    }
    if (v.offset.empty() || true)
      s << "]";
  }
