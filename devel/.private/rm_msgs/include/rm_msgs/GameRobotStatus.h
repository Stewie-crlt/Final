...
struct GameRobotStatus_
{
  ...
  GameRobotStatus_()
    ...
    , remain_hp(0)
    , max_hp(0)
    , shooter_cooling_rate(0)
    , shooter_cooling_limit(0)
  ...
  _max_hp_type max_hp;
   ...
   typedef uint16_t _shooter_cooling_rate_type;
  _shooter_cooling_rate_type shooter_cooling_rate;

   typedef uint16_t _shooter_cooling_limit_type;
...
struct MD5Sum< ::rm_msgs::GameRobotStatus_<ContainerAllocator> >
{
  ...
  static const uint64_t static_value1 = 0xac6464194db850fcULL;
  static const uint64_t static_value2 = 0x9663b0f365bf8871ULL;
};
...
struct Printer< ::rm_msgs::GameRobotStatus_<ContainerAllocator> >
{
  template<typename Stream> static void stream(Stream& s, const std::string& indent, const ::rm_msgs::GameRobotStatus_<ContainerAllocator>& v)
  {
    ...
    Printer<uint16_t>::stream(s, indent + "  ", v.shooter_cooling_rate);
    if (true || !indent.empty())
      s << std::endl;
    s << indent << "shooter_cooling_limit: ";
    Printer<uint16_t>::stream(s, indent + "  ", v.shooter_cooling_limit);
    if (true || !indent.empty())
      s << std::endl;
