...
struct ShootCmd_
{
  ...
  ShootCmd_()
    ...
    , wheel_speed(0.0)
    , hz(0.0)
    , wheels_speed_offset_front(0.0)
    , wheels_speed_offset_back(0.0)
    , stamp()  {
    }
  ...
  _hz_type hz;
   ...
   typedef double _wheels_speed_offset_front_type;
  _wheels_speed_offset_front_type wheels_speed_offset_front;

   typedef double _wheels_speed_offset_back_type;
  _wheels_speed_offset_back_type wheels_speed_offset_back;
...
bool operator==(const ::rm_msgs::ShootCmd_<ContainerAllocator1> & lhs, const ::rm_msgs::ShootCmd_<ContainerAllocator2> & rhs)
{
  return lhs.mode == rhs.mode &&
    ...
    lhs.hz == rhs.hz &&
    lhs.wheels_speed_offset_front == rhs.wheels_speed_offset_front &&
    lhs.wheels_speed_offset_back == rhs.wheels_speed_offset_back &&
    lhs.stamp == rhs.stamp;
}
...
struct MD5Sum< ::rm_msgs::ShootCmd_<ContainerAllocator> >
{
  ...
  static const uint64_t static_value1 = 0xde2a1327d879df57ULL;
  static const uint64_t static_value2 = 0xbb352ed872ea65fbULL;
};
...
namespace serialization
{
  ...
  template<class ContainerAllocator> struct Serializer< ::rm_msgs::ShootCmd_<ContainerAllocator> >
  {
    template<typename Stream, typename T> inline static void allInOne(Stream& stream, T m)
    {
      ...
      stream.next(m.hz);
      stream.next(m.wheels_speed_offset_front);
      stream.next(m.wheels_speed_offset_back);
      stream.next(m.stamp);
    }
...
struct Printer< ::rm_msgs::ShootCmd_<ContainerAllocator> >
{
  template<typename Stream> static void stream(Stream& s, const std::string& indent, const ::rm_msgs::ShootCmd_<ContainerAllocator>& v)
  {
    ...
    if (true || !indent.empty())
      s << std::endl;
    s << indent << "wheels_speed_offset_front: ";
    Printer<double>::stream(s, indent + "  ", v.wheels_speed_offset_front);
    if (true || !indent.empty())
      s << std::endl;
    s << indent << "wheels_speed_offset_back: ";
    Printer<double>::stream(s, indent + "  ", v.wheels_speed_offset_back);
    if (true || !indent.empty())
      s << std::endl;
    s << indent << "stamp: ";
