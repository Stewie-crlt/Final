...
struct MD5Sum< ::rm_msgs::TargetDetectionArray_<ContainerAllocator> >
{
  ...
  static const uint64_t static_value1 = 0x9e86cc7ec7550de1ULL;
  static const uint64_t static_value2 = 0xd0f3128a731a89a2ULL;
};
...
struct Printer< ::rm_msgs::TargetDetectionArray_<ContainerAllocator> >
{
  template<typename Stream> static void stream(Stream& s, const std::string& indent, const ::rm_msgs::TargetDetectionArray_<ContainerAllocator>& v)
  {
    ...
    if (true || !indent.empty())
      s << std::endl;
    s << indent << "is_red: ";
    Printer<uint8_t>::stream(s, indent + "  ", v.is_red);
    if (true || !indent.empty())
      s << std::endl;
    s << indent << "detections: ";
    ...
    for (size_t i = 0; i < v.detections.size(); ++i)
    {
      if (false && i > 0)
        ...
        s << std::endl << indent << "  -";
      Printer< ::rm_msgs::TargetDetection_<ContainerAllocator> >::stream(s, false ? std::string() : indent + "    ", v.detections[i]);
    }
    if (v.detections.empty() || false)
      s << "]";
  }
